        ...
        <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {projects.map((project, index) => (
            <a
              ...
              className="group flex flex-col overflow-hidden rounded-2xl border border-border bg-card transition-all hover:border-foreground/20 hover:bg-secondary hover:shadow-lg hover:shadow-foreground/5"
            >
              <div className="flex aspect-video items-center justify-center border-b border-border bg-secondary/60 text-muted-foreground">
                {project.image ? (
                  <img
                    src={project.image}
